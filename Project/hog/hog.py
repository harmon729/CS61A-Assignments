...
def make_averaged(original_function, times_called=10000):
...
def max_scoring_num_rolls(dice=six_sided, times_called=1000):
    ...
    # BEGIN PROBLEM 9
    num_rolls = 1
    max_num, max_score = 0, 0
    while num_rolls <= 10:
        res_i = make_averaged(roll_dice, times_called)(num_rolls, dice)
        if res_i > max_score:
            max_score = res_i
            max_num = num_rolls
        num_rolls += 1
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    """
    # BEGIN PROBLEM 12
    if sus_update(0, score, opponent_score) - score >= 3.5:
        return 0
    return 7
    # END PROBLEM 12
